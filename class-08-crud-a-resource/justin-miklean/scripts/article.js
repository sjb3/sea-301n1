(function(module) {
  ...
  Article.createTable = function(callback) {
    webDB.execute(//'hackerIpsum.json'
      'CREATE TABLE IF NOT EXISTS articles(id INTEGER,title TEXT,category TEXT,authorUrl TEXT,publishedOn DATETIME,body TEXT)',
      function(result) {
  ...
  //   webDB.execute(
  //     [{
  //       'sql': "UPDATE articles SET author = 'JB' WHERE author='Kenna Morar'",
  //     }],
  //     callback
  //   );
  // };
